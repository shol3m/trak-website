...
export const metadata = {
  ...
  description: 'Профессиональный ремонт и техническое обслуживание отечественных авто и иномарок в Уфе',
}
    ...
    <main className="min-h-screen bg-bg-page py-20">
      <Container>
        <SectionHeading
          ...
          subtitle="Опытные мастера и современное оборудование. Ремонтируем отечественные авто и иномарки. Гарантия на все виды работ."
        />
