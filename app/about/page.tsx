...
const stats = [
  ...
  { value: '10 000+', label: 'позиций в ассортименте' },
]
            ...
            >
              ...
              <div className="space-y-4 font-body text-text-dim leading-relaxed">
                <p>
                  ...
                  техники, предлагая более 10 000 наименований в постоянном наличии, и ремонтируем
