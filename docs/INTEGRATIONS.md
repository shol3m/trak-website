...
Существующие 280k товаров ещё не перекатегоризированы (нет сохранённого `Код_Каталога` в старых данных) — обновятся автоматически при следующей синхронизации от 1С.
